...
/**
 * Whether the color tail uses a built-in named color (`black`, `white`, `transparent`, …).
 *
 * @param rest - Color tail after the utility prefix (`/` opacity ignored for the head segment).
 * @returns `true` when the first segment is a special color keyword.
 *
