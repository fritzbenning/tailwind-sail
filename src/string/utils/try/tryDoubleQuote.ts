...
/**
 * Scans a double-quoted literal from `openIdx`; returns `extracted` when `offset` is inside.
 *
 ...
 *
 * @example tryDoubleQuote('x = "ab";', 4, 6).end => 8
 * @example tryDoubleQuote('x = "ab', 4, 5).end => 7
 */
